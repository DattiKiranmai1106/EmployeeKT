		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comsapktemployeeonboardemployeekt-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapktemployeeonboardemployeekt-display": {
								"semanticObject": "comsapktemployeeonboardemployeekt",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.kt.employeeonboard.employeekt",
									"url": sap.ui.require.toUrl("com/sap/kt/employeeonboard/employeekt")
								}
							}
						}
					}
